...
function getPosts() {
	return [
		...
		{
			title: 'Announcing Prisma Serverless Data Conference',
			body: `JsDoc is a great tool for documenting code and providing type-safety in your JavaScript project without any additional configuration.`,
		},
	];
}
